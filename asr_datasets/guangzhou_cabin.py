...
class GuangzhouCabinDataset(Dataset):
    def __init__(self, dataset_path="AlienKevin/guangzhou-cabin-speech", split='train', batch_size=64, sample_size=1000, seed=42):
